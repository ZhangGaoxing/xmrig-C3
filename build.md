...
# CPU
docker buildx build -f Dockerfile . -t zhanggaoxing/xmrig-c3:6.24.0 --progress=plain --platform linux/amd64,linux/arm64 --build-arg "ALL_PROXY=socks5://172.27.224.1:23474" --push
docker run -itd --restart=always --privileged=true -v $PWD:/xmrig/configs zhanggaoxing/xmrig-c3:6.21.3
# CUDA
docker buildx build -f Dockerfile_CUDA . -t zhanggaoxing/xmrig-c3:6.24.0-cuda --progress=plain --platform linux/amd64,linux/arm64 --push
